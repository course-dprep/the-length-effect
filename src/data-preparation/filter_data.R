...
title.basics_clean <- read_csv("gen/temp/basics_clean.csv", show_col_types = FALSE)
...
write_csv(title.basics_filtered, "gen/temp/title_basics_filtered.csv")
write.csv(title.ratings_clean, "gen/temp/title_ratings_clean.csv")